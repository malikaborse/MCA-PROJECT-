    ...
    return (
        <>
            <section className="relative h-screen overflow-hidden bg-cover bg-center flex justify-center items-center md:mt-5">
                <img src={backgroundImage} className="absolute z-0 inset-0 mx-auto my-auto w-[100vw] h-[100vh] object-cover rounded-br-[150px] rounded-tl-[50px]" />
                <div className="absolute text-center text-gray-800 flex flex-col justify-center items-center sm:w-[80vw] lg:w-[65vw] px-10 w-[80vw] h-[70vh] sm:h-[50vh] animate-fade-in">
